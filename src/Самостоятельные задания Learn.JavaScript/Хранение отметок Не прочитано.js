...
// Еще раз прочитаем сообщение (все еще 2 сообщения, т.к. в Set не могут храниться одинаковые данные)
readMessages.add(messages[0]);
...
/* или просто добавить символьное свойство вместо имени, которое известно только нашему коду
